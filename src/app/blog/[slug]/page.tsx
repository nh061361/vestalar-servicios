...
import { Menu, Facebook, Instagram, Linkedin, ArrowLeft } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 py-12 md:py-20">
        <article className="container mx-auto px-4 md:px-6 max-w-4xl">
            ...
            <p className="text-muted-foreground mb-8 text-lg">{new Date(post.date).toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
